...
class CombatTest(unittest.TestCase):
    def test_successful_attack(self):
        ...
        attacker = prime_entity.Entity(18, 18, 10, 10, 10, 10, 5, "A")
        # Melee defense: 70 (60 + 10)
        # Health: 18 Pain Tolerance: 36
        defender = prime_entity.Entity(10, 10, 18, 10, 18, 10, 1, "D")
    ...
    def test_overwhelming_attack(self):
        attacker = prime_entity.Entity(18, 18, 10, 10, 10, 10, 5, "A")
        defender = prime_entity.Entity(10, 5, 18, 10, 18, 10, 1, "D")
    ...
    def test_defender_no_pain_tolerance(self):
        attacker = prime_entity.Entity(18, 18, 10, 10, 10, 10, 5, "A")
        defender = prime_entity.Entity(10, 10, 18, 10, 18, 0, 1, "D")
